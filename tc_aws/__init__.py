...
Config.define(
    "TC_AWS_RESULT_STORAGE_BUCKET", None, "S3 bucket for result Storage", "S3"
)
Config.define(
...
Config.define(
    "TC_AWS_ALLOWED_BUCKETS", False, "List of allowed buckets to be requested", "S3"
)
...
def monkeypatch_tornado_return_future():
